 ...
 * Model:
 * - создание из файла
 * - создание с обучением по данным со степенью
 * - создание с обучением по умолчанию (генерация = 5000 + степень = 2)
 * - изменение из файла
 * - обучение по данным со степенью
 * - обучение по умолчанию (генерация = 5000 + степень = 2)
 * - сохранение в файл
 * - вычисление значения по аргументу на обученной модели
 * - функция потерь
 * - функционал потерь на выборке
 * - скользящий контроль на выборке
*/
