...
/*
 * Data:
 * - создание выборки из файла
 * - создание выборки с помощью генерации
 * - создание нулевой выборки (не пустой)
 * - перезапись выборки из файла
 * - перезапись выборки с помощью генерации
 * - перезапись выборки на нулевую
 * - случайное разбиение выборки на две выборки
 * 
 * Generator:
 * - задание отрезка аргументов для генерации
 * - функция зависимости для генерации
*/
